...
export interface SortSettings { mode: SortMode; customPrompt: string; textLimit: number; totalLimit: number; unlimited: boolean; preserveFolderTrees: boolean; }
export interface PlanItem { id: string; source: string; relativePath: string; target: string; category: string; explanation: string; confidence: number; included: boolean; warning?: string; aiStatus: AiStatus; aiError?: string; isFolder: boolean; }
